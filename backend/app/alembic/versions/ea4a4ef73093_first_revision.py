...
Revision ID: ea4a4ef73093
Revises: 
Create Date: 2020-07-18 02:36:47.145840
...
def upgrade():
    ...
    sa.Column('name', sa.String(length=256), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['created_by_id'], ['user.id'], name='fk_node_created_by_id', use_alter=True),
    sa.ForeignKeyConstraint(['parent_id'], ['node.id'], ),
    sa.ForeignKeyConstraint(['updated_by_id'], ['user.id'], name='fk_node_updated_by_id', use_alter=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    )
