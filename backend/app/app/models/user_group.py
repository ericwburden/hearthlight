...
class UserGroup(Base, Default):
    ...
    created_by_id = Column(
        Integer,
        ForeignKey("user.id", name="fk_user_group_created_by_id", use_alter=True),
        nullable=False,
    )
    ...
    updated_by_id = Column(
        Integer,
        ForeignKey("user.id", name="fk_user_group_updated_by_id", use_alter=True),
        nullable=False,
    )
    ...
    permissions_for = relationship(
        "UserGroupPermission",
        primaryjoin=(
            "and_(UserGroup.id==UserGroupPermission.resource_id, "
            "UserGroupPermission.resource_type=='user_group')"
        ),
