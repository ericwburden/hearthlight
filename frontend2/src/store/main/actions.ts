...
export const actions = {
  async actionLogIn(context: MainContext, payload: { username: string; password: string }) {
    try {
      ...
      if (token) {
        ...
        await dispatch(actions.actionGetUserProfile)(context);
        await dispatch(actions.actionRouteLoggedIn)(context);
  ...
  async actionGetUserProfile(context: MainContext) {
    try {
      ...
      await dispatch(actions.actionCheckApiError)(context, error);
    }
  },
    ...
    if (!context.state.isLoggedIn) {
      ...
      if (token) {
        try {
          ...
          await dispatch(actions.actionRemoveLogIn)(context);
        }
      } else {
        await dispatch(actions.actionRemoveLogIn)(context);
      }
  ...
  async actionLogOut(context: MainContext) {
    await dispatch(actions.actionRemoveLogIn)(context);
    await dispatch(actions.actionRouteLogOut)(context);
  },
